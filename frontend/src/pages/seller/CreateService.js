...
function CreateService() {
              ...
              .then(response => {
                  if (response.data.success) {
                      ...
                      setServiceDetails({
                          ...
                          discountDays: service.discountDays,
                          tags: service.tags,
    ...
    const updateSalesPriceAndAmount = (updatedPackages, index, name, value) => {
        ...
        updatedPackages.forEach((pkg, idx) => {
            ...
            pkg.amountToGet = pkg.salesPrice * 0.91;
        });
                    ...
                    <form className='form' onSubmit={handleSubmit}>
                        ...
                        {offerDiscount && (
                            ...
                            <div className='inputInnerDiv'>
                                ...
                                <input type="number" className='inputField' name="discountDays" value={serviceDetails.discountDays} onChange={handleChange} required />
                            </div>
                            </div>
                        )}
